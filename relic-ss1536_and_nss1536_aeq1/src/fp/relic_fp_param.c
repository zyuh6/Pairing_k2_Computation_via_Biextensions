...
#define STR_P1536_NSS	""
	...
	RLC_TRY {
		...
		switch (param) {
			...
			case NSS_1536:
				...
				bn_set_2b(t0, 128);
				bn_set_bit(t0, 22, 1);
				fp_prime_set_pairf(t0, EP_NSS2);
				bn_sqr(t1, t0);
				bn_add_dig(t1, t1, 1);
				bn_read_str(p, STR_P1536_NSS, strlen(STR_P1536_NSS), 16);
				bn_mul(p, p, t1);
				bn_dbl(p, p);
				bn_sub_dig(p, p, 1);
				fp_prime_set_dense(p);
