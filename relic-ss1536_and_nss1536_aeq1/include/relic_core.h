...
typedef struct _ctx_t {
	...
	fp_st ep_map_c[7];
	/** The a-coefficient of the twist of the elliptic curve. */
	fp_st ep_G2_a;
	/** The b-coefficient of the twist of the elliptic curve. */
	fp_st ep_G2_b;
	/** The generator of the twist of the elliptic curve. */
	ep_st ep_G2_g;
#ifdef EP_ENDOM
	fp_st beta;
