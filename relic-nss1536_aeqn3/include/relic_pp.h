...
// #define pp_add_k2_projc(L, LL, R, P, Q)	pp_add_k2_projc_lazyr_NSS(L, LL, R, P, Q)
// #else
...
#elif PP_EXT == LAZYR
// #if !defined(EP_SUPER) && FP_PRIME == 1536
// #define pp_dbl_k2_projc(L, LL, R, P, Q)	pp_dbl_k2_projc_lazyr_NSS(L, LL, R, P, Q)
// #else
...
#elif PP_MAP == OATEP
#if !defined(EP_SUPER) && FP_PRIME == 1536
#define pp_map_k2(R, P, Q)		pp_map_tatep_k2_NSS(R, P, Q)
#else
#define pp_map_k2(R, P, Q)		pp_map_tatep_k2(R, P, Q)
#endif
#endif
...
#elif PP_MAP == TATEP || PP_MAP == OATEP
#if !defined(EP_SUPER) && FP_PRIME == 1536
#define pp_map_sim_k2(R, P, Q, M)	pp_map_sim_tatep_k2_NSS(R, P, Q, M)
#else
...
void pp_add_k2_projc_lazyr_NSS(fp2_t l, fp2_t ll, ep_t r, const ep_t p, const ep_t q);
...
#define pp_dbl_k2_projc_NSS(L, LL, R, P, Q)	pp_dbl_k2_projc_lazyr_NSS(L, LL, R, P, Q)
#define pp_add_k2_projc_NSS(L, LL, R, P, Q)	pp_add_k2_projc_lazyr_NSS(L, LL, R, P, Q)
#define pp_map_k2(R, P, Q)		        pp_map_tatep_k2_NSS(R, P, Q)
// #define pp_map_sim_k2(R, P, Q, M)	        pp_map_sim_tatep_k2_NSS(R, P, Q, M)
#define pp_dbl_k2_NSS(L, LL, R, P, Q)		pp_dbl_k2_projc_NSS(L, LL, R, P, Q)
#define pp_add_k2_NSS(L, LL, R, P, Q)		pp_add_k2_projc_NSS(L, LL, R, P, Q)
#endif
#endif /* !RLC_PP_H */
