...
#define g2_get_gen(G)		ep_G2_curve_get_gen(G)
#else
 ...
 */
#if !defined(EP_SUPER) && FP_PRIME == 1536
#define g2_on_curve(P)		ep_G2_on_curve(P)
#else
 ...
 */
#if !defined(EP_SUPER) && FP_PRIME == 1536
#define g2_add(R, P, Q)		ep_G2_add(R, P, Q)
#else
 ...
 */
#if !defined(EP_SUPER) && FP_PRIME == 1536
#define g2_sub(R, P, Q)		ep_G2_sub(R, P, Q)
#else
 ...
 */
#if !defined(EP_SUPER) && FP_PRIME == 1536
#define g2_dbl(R, P)		ep_G2_dbl(R, P)
#else
